	...
	<view>
		<view style="padding-bottom: 80px;">
			...
			<view class="label-input-item textarea">
				<view>
					<textarea maxlength="-1" v-model="txtContent" @confirm="btnCopyOk" @input="textareaInput" @focus="getFous()" class="tear" placeholder="粘贴地址信息,例:姓名,手机号,地址" cursor-spacing="150" :show-confirm-bar="false"></textarea>
