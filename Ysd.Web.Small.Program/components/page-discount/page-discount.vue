	...
	<view @click="hidePopup" v-if="isActive" class="hiop">
		...
		<view class="mint-popup">
			...
			<view class="kuayue" v-if="discountKY" :style="isPC==true?'width:40%':'width:90%'">
				...
				<image src="../../static/images/guanbi.png" id="guanbi" @click="CloseImg()"></image>
