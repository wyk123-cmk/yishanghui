...
};var _default =
{
  ...
  // 小程序长按保存图片
  longSave: function longSave(barcodeImg) {
    uni.previewImage({
      current: 0,
      urls: barcodeImg,
  ...
  //微信小程序授权登录
  _mp_wx_login: function _mp_wx_login(type, mptype, callback) {
    var that = this;
    uni.showLoading({
      title: "正在登录",
      mask: true });
  ...
  //H5开始语音识别
  _H5_startRecord: function _H5_startRecord(callback) {
    var u = navigator.userAgent;
    var isiOS = !!u.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/);
    if (isiOS == false) {
      this.config();
  ...
  //H5结束语音识别
  _H5_stopRecord: function _H5_stopRecord(type, callback) {
    var u = navigator.userAgent;
    var isiOS = !!u.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/);
    if (isiOS == false) {
      this.config();
  ...
  $refsFileHtml: function $refsFileHtml(info, callback) {
    ...
    input.onchange = function (event) {
      ...
      if (_length > 9) {
        ...
        var file = fileList[i];
        var _name = file.name;
        var _split = _name.split('.');
        var suffix = _split[_split.length - 1];
        //图片不能超过10mb
        ...
        };};for (var i = 0; i < _length; i++) {var fr;var _ret = _loop();if (typeof _ret === "object") return _ret.v;
      }
    };
  ...
  chooseImage: function chooseImage(info, callback) {
    var _this = this;
    var _count = info.count == undefined ? 1 : info.count;
    uni.showLoading({
      title: "正在上传" });
    ...
    uni.chooseImage({
      ...
      success: function success(chooseImageRes) {
        var fileList = chooseImageRes.tempFiles;
        for (var i = 0; i < fileList.length; i++) {
          ...
          var arr = chooseImageRes.tempFilePaths[i].split('.');
          var suffix = arr[arr.length - 1];
          var _name = arr[arr.length - 2] + suffix;
  ...
  //微信上传图片到服务器
  ajaxUploadFile: function ajaxUploadFile(info, isSuccess, callback) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.agreeContent = exports.wxappid = exports.appId = exports.imgApiUrl = exports.feedBackApiUrl = exports.apiUrl = exports.apiHost = void 0; // export let apiHost = 'http://kyun.yshdev.cn'; //开发环境
var apiHost = 'https://test3.1718china.cn'; //测试环境
// export let apiHost = 'https://express.1718china.cn'; //正式环境
exports.apiHost = apiHost;var apiUrl = apiHost + '/api';exports.apiUrl = apiUrl;
var feedBackApiUrl = 'http://wx.1718china.cn/api'; //测试环境
...
var appId = 'yshkyWechatMini';exports.appId = appId;
...
function drawPieText(series, opts, config, context, radius, center) {
  ...
  _i11) {
    var item = textObjectCollection[_i11];
    ...
    arr.forEach(function (item, i) {
      ...
      context.fillText(txt, textStartX, y);
    });
    context.closePath();
    context.stroke();
    context.closePath();};for (var _i11 = 0; _i11 < textObjectCollection.length; _i11++) {var arr;_loop3(_i11);
  }
}
